...
int64_t sub_14142fe90(int64_t param_1, int64_t param_2, int64_t param_3, int64_t param_4, int64_t param_5) {
    ...
    sub_14142FF23(r15->field_0x20, r15, (*param_1), r12);  // 0x14142ff23
    return rax;
loc_irr_100:
    rax = (rax - 1);
    param_2 = *(rsi + (param_1 * 4));
    param_1 = r14;
    sub_141431890(r14, *(rsi + (param_1 * 4)));  // 0x14142fef6
    if (rbx == -1) {
        param_5 = rdi;
        if (rbx != -1) goto loc_irr_104;
    } else {
        if (rax < 0) goto loc_irr_106;
    }
    goto loc_irr_105;
loc_irr_106:
    param_1 = rdi;
...
loc_irr_104:
    ...
    loc_irr_116:
        ...
        if (rbx >= &r14->field_0x28) goto loc_irr_116;
    }
    goto loc_irr_118;
loc_irr_118:
    param_1 = rdi;
