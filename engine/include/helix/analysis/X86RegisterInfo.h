...
inline std::optional<X86SubRegInfo> getX86SubRegInfo(llvm::StringRef reg) {
    ...
    auto result = llvm::StringSwitch<std::optional<X86SubRegInfo>>(upper)
        ...
        .Case("XMM0",  X86SubRegInfo{"XMM0",  128, 0})
        .Case("XMM1",  X86SubRegInfo{"XMM1",  128, 0})
        .Case("XMM2",  X86SubRegInfo{"XMM2",  128, 0})
        .Case("XMM3",  X86SubRegInfo{"XMM3",  128, 0})
        .Case("XMM4",  X86SubRegInfo{"XMM4",  128, 0})
        .Case("XMM5",  X86SubRegInfo{"XMM5",  128, 0})
        .Case("XMM6",  X86SubRegInfo{"XMM6",  128, 0})
        .Case("XMM7",  X86SubRegInfo{"XMM7",  128, 0})
        .Case("XMM8",  X86SubRegInfo{"XMM8",  128, 0})
        .Case("XMM9",  X86SubRegInfo{"XMM9",  128, 0})
        .Case("XMM10", X86SubRegInfo{"XMM10", 128, 0})
        .Case("XMM11", X86SubRegInfo{"XMM11", 128, 0})
        .Case("XMM12", X86SubRegInfo{"XMM12", 128, 0})
